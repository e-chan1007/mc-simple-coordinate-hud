...
object SimpleCoordinateHUD : ClientModInitializer {
    ...
    override fun onInitializeClient() {
        ...
        configKeyBinding = KeyBindingHelper.registerKeyBinding(KeyBinding("key.simplecoordinatehud.config", InputUtil.Type.KEYSYM,
            GLFW.GLFW_KEY_SEMICOLON, KeyBinding.Category.create(Identifier.of("category.simplecoordinatehud"))))
        ...
        HudElementRegistry.addLast(Identifier.of("simplecoordinatehud", "coordinate"), run { HUDRender(client) })
